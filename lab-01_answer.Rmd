...
Obtain a copy of this questions document and the answer R Markdown file using Git.
To clone a copy of this repository to your own PC:


Once you have your copy, open the answer document in RStudio an RStudio project and work through the questions.
...
2. Plot the retweet and mentions networks from your data.
   ...
   Are there interesting dynamics in how the network grows over time (and can you visualize it)?
